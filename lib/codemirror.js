...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    connect(input, "input", function() {fastPoll();});
    ...
    function onKeyDown(e) {
      ...
      // TODO make sure readOnly still works
      if (!options.readOnly) {
    ...
    function readInput() {
      ...
      var moved = changed || sr.start != editing.start || sr.end != editing.end;
    ...
    function prepareInput() {
      ...
      setSelRange(input, startch, endch);
    }
    function focusInput() {
  ...
  CodeMirror.defaults = {
    ...
    keyMap: mac ? "macDefault" : "pcDefault",
    tabMode: "classic",
    enterMode: "indent",
    electricChars: true,
    onKeyEvent: null,
  ...
  // FIXME insert/overwrite, search/searchnext/replace, fold/unfold
